...
public class ParentItemAdapter
    ...
    ArrayList personImages = new ArrayList<>(Arrays.asList(R.drawable.g1, R.drawable.g2, R.drawable.g3, R.drawable.g4, R.drawable.g5,R.drawable.g1, R.drawable.g2, R.drawable.g3));
